...
cl /nologo /std:c++17 /O2 /W4 /fp:precise /EHsc /Iinclude ^
	src\kernels.cpp src\kernels_avx2.cpp src\alloc.cpp src\validate.cpp src\bake.cpp src\query.cpp src\compose.cpp src\analytics.cpp src\pca.cpp src\scratch.cpp ^
